# -*- coding: utf-8 -*-
#
# claude_desktop_config documentation build configuration file, created by
...
import claude_desktop_config as package
...
# Add data for Jinja2
try:
    from claude_desktop_config.docs import doc_data
except:
    doc_data = dict()
